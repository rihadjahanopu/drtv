...
export default function ChannelSidebar() {
  return (
    <aside className="flex flex-col h-full w-full bg-zinc-950/90 backdrop-blur-2xl border-r border-zinc-800/50">
      <div className="flex-shrink-0 pt-6 pb-4 px-6 border-b border-zinc-800/50 bg-gradient-to-b from-zinc-900/40 to-transparent">
        <h1 className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500 tracking-tighter flex items-center gap-2.5">
