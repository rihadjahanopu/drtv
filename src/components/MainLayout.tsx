  ...
  return (
    <main className="flex h-[100dvh] w-full bg-black overflow-hidden text-zinc-100 font-sans selection:bg-blue-500/30">
      <div className="flex flex-col md:flex-row w-full h-full relative">
        <div className="flex-1 h-[35dvh] md:h-full relative z-10 bg-black md:p-6 p-0 order-1 md:order-2 flex items-center justify-center border-b border-zinc-800/40 md:border-b-0 shadow-lg shadow-black/80 md:shadow-none">
        ...
        <div className="w-full h-[65dvh] md:h-full md:w-[380px] lg:w-[420px] flex-shrink-0 z-20 shadow-[0_0_50px_rgba(0,0,0,0.5)] order-2 md:order-1 relative">
          <ChannelSidebar />
        </div>
      </div>
    </main>
